...
public class Mensajes {
    ...
    public static final String DATOS_GUARDADOS_EXITOSAMENTE = "DATOS_GUARDADOS_EXITOSAMENTE";
    public static final String ERROR_ACTUALIZAR_DATOS = "ERROR_ACTUALIZAR_DATOS";
