...
CREATE TABLE `cnt_asiento_contable` (
  ...
  CONSTRAINT `fk_cnt_asiento_contable_10` FOREIGN KEY (`id_devolucion`) REFERENCES `cnt_devolucion` (`id_devolucion`) ON DELETE CASCADE ON UPDATE CASCADE,
  ...
  CONSTRAINT `fk_cnt_asiento_contable_8` FOREIGN KEY (`id_pago_anticipado_transaccion`) REFERENCES `cnt_pago_anticipado_transaccion` (`id_pago_anticipado_transaccion`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_cnt_asiento_contable_9` FOREIGN KEY (`id_pago_anticipado`) REFERENCES `cnt_pago_anticipado` (`id_pago_anticipado`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=5295 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `cnt_boleto` (
  ...
  `impuesto_1_nombre` varchar(32) DEFAULT NULL,
  `impuesto_1` decimal(12,2) DEFAULT NULL,
  `impuesto_2_nombre` varchar(32) DEFAULT NULL,
  `impuesto_2` decimal(12,2) DEFAULT NULL,
  `impuesto_3_nombre` varchar(32) DEFAULT NULL,
  `impuesto_3` decimal(12,2) DEFAULT NULL,
  `impuesto_4_nombre` varchar(32) DEFAULT NULL COMMENT 'OTROS IMPUESTOS',
  `impuesto_4` decimal(12,2) DEFAULT NULL,
  `impuesto_5_nombre` varchar(32) DEFAULT NULL,
...
CREATE TABLE `cnt_cargo_boleto` (
  ...
  `concepto` varchar(512) DEFAULT NULL,
  `tipo` varchar(1) DEFAULT NULL,
  ...
  CONSTRAINT `fk_cnt_cargo_boleto_5` FOREIGN KEY (`id_nota_debito`) REFERENCES `cnt_nota_debito` (`id_nota_debito`) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE `cnt_cliente` (
  ...
  `nit` varchar(128) DEFAULT NULL,
  `direccion` varchar(128) DEFAULT NULL,
  `telefono_fijo` varchar(128) DEFAULT NULL,
  `telefono_celular` varchar(128) DEFAULT NULL,
  `email` varchar(128) DEFAULT NULL,
  ...
  `representante` varchar(64) DEFAULT NULL,
  `representante_direccion` varchar(128) DEFAULT NULL,
  `representante_telefono` varchar(128) DEFAULT NULL,
  `representante_celular` varchar(128) DEFAULT NULL,
  `representante_ci` varchar(12) DEFAULT NULL,
  `fecha_alta` date DEFAULT NULL,
  `representante_nacimiento` varchar(10) DEFAULT NULL,
  `representante_email` varchar(128) DEFAULT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=13425 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `cnt_comprobante_contable` (
  ...
  CONSTRAINT `fk_cnt_comprobante_contable_1` FOREIGN KEY (`id_nota_debito`) REFERENCES `cnt_nota_debito` (`id_nota_debito`) ON DELETE CASCADE ON UPDATE CASCADE,
  ...
  CONSTRAINT `fk_cnt_comprobante_contable_4` FOREIGN KEY (`id_ingreso_caja`) REFERENCES `cnt_ingreso_caja` (`id_ingreso_caja`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_cnt_comprobante_contable_5` FOREIGN KEY (`id_nota_credito`) REFERENCES `cnt_nota_credito` (`id_nota_credito`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_cnt_comprobante_contable_6` FOREIGN KEY (`id_pago_anticipado`) REFERENCES `cnt_pago_anticipado` (`id_pago_anticipado`) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE `cnt_debito_ingreso` (
  ...
  CONSTRAINT `fk_cnt_debito_ingreso_1` FOREIGN KEY (`id_ingreso_caja`) REFERENCES `cnt_ingreso_caja` (`id_ingreso_caja`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_cnt_debito_ingreso_2` FOREIGN KEY (`id_nota_debito`) REFERENCES `cnt_nota_debito` (`id_nota_debito`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `cnt_devolucion` (
  ...
  CONSTRAINT `fk_cnt_devolucion_2` FOREIGN KEY (`id_nota_debito`) REFERENCES `cnt_nota_debito` (`id_nota_debito`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_cnt_devolucion_3` FOREIGN KEY (`id_pago_anticipado`) REFERENCES `cnt_pago_anticipado` (`id_pago_anticipado`) ON DELETE CASCADE ON UPDATE CASCADE,
...
) ENGINE=InnoDB AUTO_INCREMENT=20000027 DEFAULT CHARSET=latin1 COMMENT='cnt_cliente_id_cliente';
/*!40101 SET character_set_client = @saved_cs_client */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
...
CREATE TABLE `cnt_ingreso_transaccion` (
  ...
  CONSTRAINT `cnt_ingreso_transaccion_ibfk_1` FOREIGN KEY (`id_ingreso_caja`) REFERENCES `cnt_ingreso_caja` (`id_ingreso_caja`) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE `cnt_nota_credito_transaccion` (
  ...
  CONSTRAINT `fk_cnt_nota_credito_transaccion_1` FOREIGN KEY (`id_nota_credito`) REFERENCES `cnt_nota_credito` (`id_nota_credito`) ON DELETE CASCADE ON UPDATE CASCADE,
...
) ENGINE=InnoDB AUTO_INCREMENT=10000031 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
...
CREATE TABLE `cnt_pago_anticipado_transaccion` (
  ...
  CONSTRAINT `fk_cnt_pago_anticipado_transaccion_1` FOREIGN KEY (`id_pago_anticipado`) REFERENCES `cnt_pago_anticipado` (`id_pago_anticipado`) ON DELETE CASCADE ON UPDATE CASCADE,
  ...
  CONSTRAINT `fk_cnt_pago_anticipado_transaccion_3` FOREIGN KEY (`id_devolucion`) REFERENCES `cnt_devolucion` (`id_devolucion`) ON DELETE NO ACTION ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `cnt_plan_cuentas` (
  ...
  `tipo_regularizacion` varchar(1) DEFAULT NULL,
  `id_cuenta_regularizacion` int(11) DEFAULT NULL,
...
CREATE TABLE `tb_contabilidad_boletaje` (
  ...
  `diferencia_cambio` int(11) DEFAULT NULL,
  `utilidad_gestion` int(11) DEFAULT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=46495 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `tmp_estados_resultados`
--

DROP TABLE IF EXISTS `tmp_estados_resultados`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tmp_estados_resultados` (
  `v_id_plan_cuenta` int(11) DEFAULT NULL,
  `v_cuenta` varchar(40) DEFAULT NULL,
  `v_nro_plan_cuenta` bigint(20) DEFAULT NULL,
  `v_nro_plan_cuenta_padre` bigint(20) DEFAULT NULL,
  `v_suma_debe` decimal(16,2) DEFAULT NULL,
  `v_suma_haber` decimal(16,2) DEFAULT NULL,
  `v_saldo_debe` decimal(16,2) DEFAULT NULL,
  `v_saldo_haber` decimal(16,2) DEFAULT NULL,
  `v_nivel` int(11) DEFAULT NULL,
  `v_saldo` varchar(64) DEFAULT NULL,
  `v_saldo_monto` decimal(16,2) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `balanceGeneral` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
drop temporary table if exists tmp_balance_general ;
create temporary table tmp_balance_general (
	 v_id_plan_cuenta			INT(11),
     v_cuenta					varchar(40),
     v_nro_plan_cuenta			varchar(20),
	 v_nro_plan_cuenta_padre	varchar(20) ,
	 v_saldo_debe				decimal(16,2) ,
	 v_saldo_haber				decimal(16,2) ,
	 v_nivel					int
) ;

call estadoResultadoBG(in_start_date, in_end_date, in_moneda, in_id_empresa) ;

call balanceGeneralUtilidadGestion () ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `balanceGeneralObtenerActivos` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`web_contabilidad`@`%` PROCEDURE `balanceGeneralObtenerActivos`()
BEGIN

drop temporary table if exists tmp_balance_general_activos ;
create temporary table tmp_balance_general_activos (
	 v_id_plan_cuenta			INT(11),
     v_cuenta					varchar(40),
     v_nro_plan_cuenta			varchar(20),
	 v_nro_plan_cuenta_padre	varchar(20) ,
...
insert into tmp_balance_general_activos
	(v_id_plan_cuenta, 
     v_cuenta, 
     v_nro_plan_cuenta,
...
(
    ...
    where v_nro_plan_cuenta like '1%' 
 )  t 
 where t.v_saldo_debe <> 0.00 or t.v_saldo_haber <>0.00
order by t.v_nro_plan_cuenta, t.v_nro_plan_cuenta_padre ;
...
insert into tmp_balance_general_activos
	...
	select  0, 
            ...
            5 
	from tmp_balance_general t
    where v_nro_plan_cuenta like '1%' and v_nivel = 1 ;
     
	select * from tmp_balance_general_activos;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `balanceGeneralObtenerPasivos` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`web_contabilidad`@`%` PROCEDURE `balanceGeneralObtenerPasivos`()
BEGIN

drop temporary table if exists tmp_balance_general_pasivos ;
create temporary table tmp_balance_general_pasivos (
	 v_id_plan_cuenta			INT(11),
     v_cuenta					varchar(40),
     v_nro_plan_cuenta			varchar(20),
	 v_nro_plan_cuenta_padre	varchar(20) ,
...
insert into tmp_balance_general_pasivos
	(v_id_plan_cuenta, 
     v_cuenta, 
     v_nro_plan_cuenta,
     v_nro_plan_cuenta_padre, 
...
(
	select  t.v_id_plan_cuenta, 
            ...
            t.v_nivel 
	from tmp_balance_general t
    where v_nro_plan_cuenta like '201%' 
 )  t 
 where t.v_saldo_debe <> 0.00 or t.v_saldo_haber <>0.00
order by t.v_nro_plan_cuenta, t.v_nro_plan_cuenta_padre ;
...
insert into tmp_balance_general_pasivos
	...
	select  0, 
            ...
            5 
	from tmp_balance_general t
    where v_nro_plan_cuenta like '201%' and v_nivel = 2 ;
     
	-- select * from tmp_balance_general_pasivos;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `balanceGeneralObtenerPasivosPatrimonio` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`web_contabilidad`@`%` PROCEDURE `balanceGeneralObtenerPasivosPatrimonio`()
BEGIN

DECLARE total_pasivo_debe 		decimal(16,2);
DECLARE total_pasivo_haber 		decimal(16,2);
DECLARE total_patrimonio_debe 	decimal(16,2);
DECLARE total_patrimonio_haber 	decimal(16,2);

call balanceGeneralObtenerPasivos();
call balanceGeneralObtenerPatrimonio();

select v_saldo_debe, v_saldo_haber into @total_pasivo_debe, @total_pasivo_haber
from tmp_balance_general_pasivos 
where v_cuenta = 'TOTAL PASIVOS'
;

select v_saldo_debe, v_saldo_haber into @total_patrimonio_debe, @total_patrimonio_haber
from tmp_balance_general_patrimonio 
where v_cuenta = 'TOTAL PATRIMONIO'
;

select v_id_plan_cuenta, 
     v_cuenta, 
     v_nro_plan_cuenta,
     v_nro_plan_cuenta_padre, 
     format(v_saldo_debe,2), 
     format(v_saldo_haber,2), 
     v_nivel 
from  (
	select v_id_plan_cuenta, 
		 v_cuenta, 
		 ...
		 v_saldo_debe, 
		 v_saldo_haber,
		 v_nivel from  tmp_balance_general_pasivos
	union
	select v_id_plan_cuenta, 
		 v_cuenta, 
		 v_nro_plan_cuenta,
		 ...
		 v_saldo_debe, 
		 v_saldo_haber, 
		 v_nivel from tmp_balance_general_patrimonio 
	union
	select 
		0 v_id_plan_cuenta, 
		'TOTAL PASIVO Y PATRIMONIO' v_cuenta, 
		null v_nro_plan_cuenta,
		null v_nro_plan_cuenta_padre, 
		if( @total_pasivo_debe > 0,  if(@total_patrimonio_debe > 0, @total_pasivo_debe + @total_patrimonio_debe, @total_pasivo_debe - @total_patrimonio_haber ) ,0 ),
		if( @total_pasivo_haber > 0,  if(@total_patrimonio_haber > 0, @total_pasivo_haber + @total_patrimonio_haber, @total_pasivo_haber - @total_patrimonio_debe ) ,0 ), 
		5 v_nivel
) A
;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `balanceGeneralObtenerPatrimonio` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`web_contabilidad`@`%` PROCEDURE `balanceGeneralObtenerPatrimonio`()
BEGIN

declare v_saldo_debe_total decimal(16,2) ;
declare v_saldo_haber_total decimal(16,2) ;

drop temporary table if exists tmp_balance_general_patrimonio ;
create temporary table tmp_balance_general_patrimonio (
	 v_id_plan_cuenta			INT(11),
     v_cuenta					varchar(40),
     v_nro_plan_cuenta			varchar(20),
	 v_nro_plan_cuenta_padre	varchar(20) ,
...
insert into tmp_balance_general_patrimonio
	(v_id_plan_cuenta, 
     v_cuenta, 
     v_nro_plan_cuenta,
     v_nro_plan_cuenta_padre, 
...
(
	select  t.v_id_plan_cuenta, 
            ...
            t.v_nivel 
	from tmp_balance_general t
    where v_nro_plan_cuenta like '202%' and v_nivel in (2,3) 
 )  t 
 where t.v_saldo_debe <> 0.00 or t.v_saldo_haber <>0.00
order by t.v_nro_plan_cuenta, t.v_nro_plan_cuenta_padre ;
...
insert into tmp_balance_general_patrimonio
	...
	select v_id_plan_cuenta, 
		 ...
		 v_nro_plan_cuenta,
		 v_nro_plan_cuenta_padre, 
		 if (v_saldo_debe > v_saldo_haber, v_saldo_debe - v_saldo_haber, 0) v_saldo_debe, 
		 if (v_saldo_haber > v_saldo_debe  , v_saldo_haber- v_saldo_debe, 0)v_saldo_haber, 
		 v_nivel
	from
	(

		select  0 v_id_plan_cuenta, 
				'TOTAL PATRIMONIO' v_cuenta, 
				null v_nro_plan_cuenta,
				null v_nro_plan_cuenta_padre, 
				sum(t.v_saldo_debe) v_saldo_debe, 
				sum(t.v_saldo_haber) v_saldo_haber, 
				5 v_nivel
		from tmp_balance_general t
		where v_nro_plan_cuenta like '202%' and v_nivel in (3) 
	) A ;
    
    
    select v_saldo_debe , v_saldo_haber into @v_saldo_debe_total,@v_saldo_haber_total from tmp_balance_general_patrimonio where v_cuenta = 'TOTAL PATRIMONIO' ;
    
    update tmp_balance_general_patrimonio
    set v_saldo_debe = @v_saldo_debe_total,
    v_saldo_haber = @v_saldo_haber_total
    where v_cuenta = 'PATRIMONIO' ;
     
	-- select * from tmp_balance_general_patrimonio;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `balanceGeneralUtilidadGestion` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`web_contabilidad`@`%` PROCEDURE `balanceGeneralUtilidadGestion`()
BEGIN

	DECLARE v_id_plan_cuenta_gestion 	INT(11) ;
    DECLARE v_nro_plan_cuenta_gestion	BIGINT(20) ;
    DECLARE v_nro_plan_padre_gestion	BIGINT(20) ;
    ...
    loop_cur_sumas_saldos : loop     
		...
		insert into tmp_balance_general (
             ...
             vx_id_plan_cuenta ,
			 vx_cuenta ,
			 cast(vx_nro_plan_cuenta  as char),
			 cast(vx_nro_plan_cuenta_padre as char),
			 vx_saldo_debe ,
			 vx_saldo_haber,
			 vx_nivel
             );
    ...
    open cur_gestion ;
		loop_cur_gestion : loop          
            ...
            insert into tmp_balance_general (
             ...
             v_id_plan_cuenta_gestion ,
			 v_cuenta_gestion ,
			 cast(v_nro_plan_cuenta_gestion as char) ,
			 cast(v_nro_plan_padre_gestion as char) ,
			 if(v_saldo_monto > 0 , v_saldo_monto,0  ) ,
			 if(v_saldo_monto < 0 , v_saldo_monto,0  ),
			 3 -- v_nivel_gestion lo colocamos como 3 para que sume
             );
...
(
	select  t.v_id_plan_cuenta, 
			t.v_cuenta, 
            cast(t.v_nro_plan_cuenta as char) v_nro_plan_cuenta,
            cast(t.v_nro_plan_cuenta_padre as char)v_nro_plan_cuenta_padre , 
            t.v_saldo_debe, 
            t.v_saldo_haber, 
            t.v_nivel 
	from tmp_balance_general t
...
BEGIN
    ...
    DECLARE v_id_cuenta_gestion 	INT(11) ;
    DECLARE v_cuenta_gestion		VARCHAR(64);
    DECLARE v_nro_plan_gestion		BIGINT(20) ;
    DECLARE v_saldo					DECIMAL(16,2);
 ...
 -- solo se toma INGRESOS y EGRESOS    
    ...
    update cnt_plan_cuentas 
    set saldo = @v_saldo_ingreso- @v_saldo_egreso
    where id_plan_cuentas =v_id_cuenta_gestion ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `estadoResultadoBG` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`web_contabilidad`@`%` PROCEDURE `estadoResultadoBG`(
 in in_start_date date 
 , in in_end_date date 
 , in in_moneda varchar(1)
 , in in_id_empresa int
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `estadoResultadoSumaSaldo` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `generarEstadoCliente` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`web_contabilidad`@`localhost` PROCEDURE `generarEstadoCliente`()
BEGIN
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `generarReporteClienteEstados` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `historicoCliente` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`web_contabilidad`@`localhost` PROCEDURE `historicoCliente`(
...
DECLARE cur_nota_debito CURSOR FOR
	...
	from cnt_nota_debito nd 
    inner join cnt_nota_debito_transaccion ndtr on ndtr.id_nota_debito = nd.id_nota_debito
    where nd.id_cliente = in_id_cliente and nd.fecha_emision between in_start_date and in_end_date ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `tmp_updatePagoAnticipado` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
-- Dump completed on 2019-12-10  0:10:35
