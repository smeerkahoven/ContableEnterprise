 ...
 * @author xeio
 */
@Named(value = "comprobantesContador")
@RequestScoped
public class ComprobantesContadorManagedBean extends ViewManagedBean {
     ...
     */
    public ComprobantesContadorManagedBean() {
        this.formName = "comprobantes-contador";
    }
    ...
    public void init() {
        try {
            ...
            Logger.getLogger(ComprobantesContadorManagedBean.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
}
