 ...
 * @author xeio
 */
@WebServlet(name = "EstadoResultadoServlet", urlPatterns = {"/EstadoResultadoServlet"})
public class EstadoResultadoReporServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String moneda = ( request.getParameter("mn"));
            /*Integer idEmpresa = Integer.parseInt(request.getParameter("pu"));*/
            HashMap hm = null;
            hm = new HashMap();
            ...
            try {
                ...
                hm.put("EMPRESA_ID", idEmpresa);
                hm.put("MONEDA", moneda);
                hm.put("PATH_SUBREPORTE", "contabilidad/estado_resultado.jasper");*/
                
                hm.put("FECHA_INICIO", DateContable.fromFormatToOtherFormat(fechaInicio, "dd/MM/yyyy", "yyyy/MM/dd"));
                hm.put("FECHA_FIN", DateContable.fromFormatToOtherFormat(fechaFin, "dd/MM/yyyy", "yyyy/MM/dd"));
                hm.put("EMPRESA_ID","1");
                hm.put("MONEDA", moneda);
                hm.put("PATH_SUBREPORTE", "contabilidad/estado_resultado.jasper");
