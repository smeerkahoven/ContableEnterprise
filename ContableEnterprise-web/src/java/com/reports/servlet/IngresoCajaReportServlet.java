 ...
 * @author xeio
 */
@WebServlet(name = "IngresoCajaReportServlet", urlPatterns = {"/IngresoCajaReportServlet"})
public class IngresoCajaReportServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String subreporte = "contabilidad/ingreso_caja"+contenido+".jasper";
            File archivoReporte = new File(request.getSession().getServletContext().getRealPath(jrxmlFileName));
            Integer idNotaDebito = Integer.parseInt(request.getParameter("idIngreso"));
            HashMap hm = null;
            hm = new HashMap();
            ...
            try {
                ...
                hm.put("ID_INGRESO", idNotaDebito);
