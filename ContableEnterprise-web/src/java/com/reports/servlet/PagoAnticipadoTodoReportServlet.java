 ...
 * @author xeio
 */
@WebServlet(name = "PagoAnticipadoTodoReport", urlPatterns = {"/PagoAnticipadoTodoReport"})
public class PagoAnticipadoTodoReportServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            try {
                ...
                hm.put("PATH_SUBREPORTE", "contabilidad/pago_anticipado_todo.jasper");
