 ...
 * @author xeio
 */
@WebServlet(name = "NotaCreditoReportServlet", urlPatterns = {"/NotaCreditoReportServlet"})
public class NotaCreditoReportServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Integer idNotaCredito = Integer.parseInt(request.getParameter("idNotaCredito"));
            HashMap hm = null;
            hm = new HashMap();
            ...
            try {
                ...
                hm.put("ID_CREDITO", idNotaCredito);
                hm.put("PATH_SUBREPORTE", "contabilidad/nota_credito.jasper");
