 ...
 * @author xeio
 */
@WebServlet(name = "ReportesComisionClienteServlet", urlPatterns = {"/ReportesComisionClienteServlet"})
public class ReporteComisionClienteServlet extends HttpServlet {
    ...
    public void verReporte(String reportPath, HashMap parameters) {
        ...
        try {
            FacesContext facesContext = FacesContext.getCurrentInstance();
            String path = facesContext.getExternalContext().getRealPath("/resources/cabecera_h.jasper");
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            String jrxmlFileName = "/resources/cabecera_h.jasper";
            ...
            try {
                ...
                hm.put("PATH_SUBREPORTE", "boletos/comision-clientes.jasper");
