 ...
 * @author xeio
 */
@WebServlet(name = "DevolucionReport", urlPatterns = {"/DevolucionReport"})
public class DevolucionReportServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Integer idNotaDebito = Integer.parseInt(request.getParameter("idDev"));
            HashMap hm = null;
            hm = new HashMap();
            ...
            try {
                ...
                hm.put("ID_DEVOLUCION", idNotaDebito);
                hm.put("PATH_SUBREPORTE", "contabilidad/devolucion.jasper");
