...
angular.module('jsBoletaje.controllers', []).controller('frmBoletaje',
        ['$scope', '$http', '$uibModal', '$window', function ($scope, $http, $window) {
                ...
                $scope.getCuentas = function () {
                    ...
                    return $http({
                        ...
                        if (response.data.code === 201) {
                            ...
                            $scope.formData.utilidadGestion = $scope.findCta($scope.formData.utilidadGestion, $scope.comboCuentas);
                ...
                $scope.formHasError = function () {
                    ...
                    //utilidad gestion
                    if ($scope.formData.utilidadGestion === undefined) {
                        return true ;
                    }else {
                        if ($scope.formData.utilidadGestion.id === undefined){
                            return true ;
                        }
                    }
