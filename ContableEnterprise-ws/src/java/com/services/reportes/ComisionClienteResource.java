 ...
 * @author xeio
 */
@Path("reportes/comision-cliente")
public class ComisionClienteResource extends TemplateResource {
     ...
     */
    public ComisionClienteResource() {
    }
    ...
    public RestResponse getPlanillaBsp(final RestRequest request) {
        ...
        try {
            ...
            List<BoletoPlanillaBsp> list = ejbBoleto.getReporteComisionCliente(search);

            response.setCode(ResponseCode.RESTFUL_SUCCESS.getCode());
            response.setContent(list);

        } catch (CRUDException ex) {
            Logger.getLogger(ComisionClienteResource.class.getName()).log(Level.SEVERE, null, ex);
