...
public class HistoricoClienteResource extends TemplateResource {
     ...
     */
    public HistoricoClienteResource() {
    }
    ...
    public RestResponse generarKardex (final RestRequest request) {
        ...
        if (response.getCode() == ResponseCode.RESTFUL_SUCCESS.getCode()){
            ...
            try {
                ...
                List <KardexClienteDto> l = ejbKardex.generarHistorico(json);
                if (l.isEmpty()) {
                ...
                Logger.getLogger(HistoricoClienteResource.class.getName()).log(Level.SEVERE, null, ex);
            }
