...
public interface NotasCreditoRemote extends DaoRemoteFacade {
    ...
    /**
     * Coloca la nota de credito a ANULADO y sus transacciones automaticamente pasan a ANULADO
    ...
    /**
     * Actualiza la transaccion de la Nota de Credito verificando los valores sean correctos
     * @param trx
     * @return
     * @throws CRUDException 
     */
